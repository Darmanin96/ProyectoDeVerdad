...
public class tutorEmpresaController implements Initializable {
            ...
            tutorEmpresaStage.setOnHidden(e -> {
                ...
                if (tutor_EmpresaCreateController.isConfirmar()) {
                    ...
                    if (nuevoId > 0) {
                        ...
                        AsignacionSelectedController asignacionSelectedController = new AsignacionSelectedController();
                        asignacionSelectedController.obtenerTutoresEmpresa();
                    } else {
    ...
    public void initialize(URL location, ResourceBundle resources) {
            ...
            idEmpresa.setCellValueFactory(cellData -> cellData.getValue().id_EmpresaProperty().asObject());
