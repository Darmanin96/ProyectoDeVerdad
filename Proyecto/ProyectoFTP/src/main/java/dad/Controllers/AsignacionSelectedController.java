...
public class AsignacionSelectedController implements Initializable {
    ...
    public List<Integer> obtenerAlumnos() {
    ...
    public List<Integer> obtenerEmpresas() {
    ...
    public List<Integer> obtenerTutoresDocente() {
    ...
    public List<Integer> obtenerTutoresEmpresa() {
