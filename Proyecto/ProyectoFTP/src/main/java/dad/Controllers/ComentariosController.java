...
public class ComentariosController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        idEmpresa.setCellValueFactory(cellData -> cellData.getValue().idEmpresaProperty().asObject());
        cargarTablaComentarios();
        ...
        idComentario.textProperty().addListener((observable, oldValue, newValue) -> {
            Comentarios selectedComentario = tableComentarios.getSelectionModel().getSelectedItem();
            if (selectedComentario != null) {
                selectedComentario.setComentario(newValue);
            }
        });
    }
