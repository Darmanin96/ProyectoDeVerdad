...
public class AsignacionController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        IdTutorEmpresa.setCellValueFactory(cellData -> cellData.getValue().idTutorEmpresaProperty().asObject());
        IdTutorGrupo.setCellValueFactory(cellData -> cellData.getValue().idTutorGrupoProperty().asObject());
        cargarTablaAsignacion();
